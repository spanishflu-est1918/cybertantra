...
export async function POST(request: Request) {
  ...
  try {
    ...
    console.log('AI SDK Stream - Temp file created:', tempFilePath, 'size:', audioBuffer.length);
    ...
    try {
      ...
      console.log('AI SDK Stream - Transcription completed in:', duration + 'ms');
      console.log('AI SDK Stream - Transcript result:', result.text ? `"${result.text}"` : 'empty');
