...
export const AUDIO_CONFIG = {
  ...
  sidechain: {
    threshold: 0.05, // Compression starts at this voice level
    ratio: 10, // 10:1 compression ratio (noticeable ducking)
    attack: 5, // 5ms attack (fast response to voice)
    release: 250, // 250ms release (moderate return when voice stops)
  },
